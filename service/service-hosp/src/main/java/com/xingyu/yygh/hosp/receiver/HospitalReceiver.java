package com.xingyu.yygh.hosp.receiver;
...
import com.xingyu.yygh.vo.order.OrderMqVo;
...
public class HospitalReceiver {
    ...
    public void receiver(OrderMqVo orderMqVo, Message message, Channel channel) throws IOException {
        if(null != orderMqVo.getAvailableNumber()) {
            ...
            //取消预约更新预约数
            try {
                Schedule schedule = scheduleService.getScheduleId(orderMqVo.getScheduleId(), orderMqVo.getHosCode());
