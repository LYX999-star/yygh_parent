package com.xingyu.yygh.hosp.controller;
...
import com.xingyu.yygh.vo.hosp.HospitalSetQueryVo;
...
public class HospitalSetController {
    ...
    public Result removeHospSet(@PathVariable Long id) {
        if (id == 21210L) {
            throw new YyghException("是你啊", 500);
        }
...
//        hospitalSetService.updateById(hospitalSet);
        ...
        wrapper.eq("id", id);
        hospitalSetService.update(wrapper);
        return Result.ok();
    }
