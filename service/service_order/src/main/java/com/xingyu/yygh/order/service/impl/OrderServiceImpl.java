package com.xingyu.yygh.order.service.impl;
...
import com.xingyu.yygh.enums.OrderStatusEnum;
import com.xingyu.yygh.hosp.client.HospitalFeignClient;
import com.xingyu.yygh.model.order.OrderInfo;
import com.xingyu.yygh.model.user.Patient;
import com.xingyu.yygh.order.mapper.OrderMapper;
import com.xingyu.yygh.order.service.OrderService;
//import com.xingyu.yygh.order.service.WeixinService;
import com.xingyu.yygh.user.client.PatientFeignClient;
import com.xingyu.yygh.vo.hosp.ScheduleOrderVo;
import com.xingyu.yygh.vo.msm.MsmVo;
import com.xingyu.yygh.vo.order.*;
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        if (result.getInteger("code") == 200) {
            ...
            Map<String, Object> param = new HashMap<String, Object>() {{
                ...
                put("amount", orderInfo.getAmount().toString());
                put("reserveDate", reserveDate);
                put("reserveTime", orderInfo.getReserveTime().toString());
                put("name", orderInfo.getPatientName());
                put("quitTime", new DateTime(orderInfo.getQuitTime()).toString("yyyy-MM-dd HH:mm"));
                put("hospname", orderInfo.getHosname());
                put("depname", orderInfo.getDepname());
                put("docname", scheduleOrderVo.getDocname());
                put("number", number.toString());
                put("fetchTime", fetchTime);
                put("fetchAddress", fetchAddress);
                put("title", scheduleOrderVo.getTitle());
                put("type", "ORDER");
            }};
